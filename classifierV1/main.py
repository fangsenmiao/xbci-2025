...
class Trans():
    ...
    def __init__(self, input_pth, model_pth):
        ...
        # 初始化模型
        self.model, self.target_mean, self.target_std, self.Wb = self.load_model_and_preprocess(model_pth + 'model.pth')
...
def main():
    ...
    parser.add_argument('--input', type=str, default='data/test', help='测试文件夹路径')
